    ...
    <div className="page landing-page">
      <nav className="landing-nav">
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          <button className="btn btn-ghost" style={{ width: 'auto', padding: '8px 16px' }} onClick={onSignIn}>
            Sign in
          </button>
          <button className="btn" style={{ width: 'auto', padding: '8px 16px' }} onClick={onSignUp}>
            Get started
          </button>
        </div>
      </nav>
      ...
      <div className="hero">
        ...
        <button className="btn hero-cta" onClick={onSignUp}>
